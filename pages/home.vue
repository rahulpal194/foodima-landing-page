<template>
    ...
    =================================-->
    <section class="bg-[url('/images/six-steps-bg.png')] bg-no-repeat bg-cover mb-20">
            ...
            <div class="grid grid-cols-12 lg:grid-cols-9 gap-6 mb-6">
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="group h-full bg-[#F6F9FC] rounded-2xl p-6 hover:shadow-card hover:bg-white transition-all duration-300 flex flex-col gap-6">
                        ...
                        <button class="button !px-6 w-fit group-hover:border-none group-hover:bg-gradient-to-b group-hover:from-secondary group-hover:to-primary group-hover:text-white group-hover:shadow-gradient-button">Open Support Ticket</button>
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6 lg:col-span-5">
                    <div class="group h-full bg-[#F6F9FC] rounded-2xl p-6 hover:shadow-card hover:bg-white transition-all duration-300 flex flex-col gap-6">
                        ...
                        <button class="button !px-6 w-fit group-hover:border-none group-hover:bg-gradient-to-b group-hover:from-secondary group-hover:to-primary group-hover:text-white group-hover:shadow-gradient-button">Read Documentation</button>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-12 lg:grid-cols-9 gap-6">
                <div class="col-span-12 md:col-span-6 lg:col-span-5">
                    <div class="group h-full bg-[#F6F9FC] rounded-2xl p-6 hover:shadow-card hover:bg-white transition-all duration-300 flex flex-col gap-6">
                        ...
                        <button class="button !px-6 w-fit group-hover:border-none group-hover:bg-gradient-to-b group-hover:from-secondary group-hover:to-primary group-hover:text-white group-hover:shadow-gradient-button">View FAQs</button>
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="group h-full bg-[#F6F9FC] rounded-2xl p-6 hover:shadow-card hover:bg-white transition-all duration-300 flex flex-col gap-6">
                        ...
                        <button class="button !px-6 w-fit group-hover:border-none group-hover:bg-gradient-to-b group-hover:from-secondary group-hover:to-primary group-hover:text-white group-hover:shadow-gradient-button">Watch Videos</button>
                    </div>
                </div>
            </div>
        </div>   
